                    ...
                    if steps % print_ev == 0:
                        ...
                        with torch.no_grad():
                            ...
                            print("Epoch: {}/{}.. ".format(x+1, epochs),
                                "Train_Loss: {:.3f}.. ".format(running_loss/print_ev),
                                "Train_Accuracy: {:.3f}".format(train_accuracy/print_ev),
                                "Valid_Loss: {:.3f}.. ".format(valid_lo/len(valid_dataloader)),
                                "Valid_Accuracy: {:.3f}".format(valid_acc/len(valid_dataloader)))
                            running_loss = 0
                            train_accuracy = 0
                            model.train()
